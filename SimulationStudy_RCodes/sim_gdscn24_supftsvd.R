...
Eta2<-list(c(1,1.5),c(2,2.25),c(3,4)) # error variance
gam<-list(c(1.5,3),c(2,3.4)) # partial slopes
...
write.csv(Res2,file=paste(dirP,"SupFTSVD",pdim,"_DGDSCN2_4.csv",sep=""),row.names = FALSE)
